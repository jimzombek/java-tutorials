 ...
 * (C:\\Users\\jmzombe\\.aws\\credentials) where the sample code will load the credentials from.
 * <p>
...
public class SimpleQueueServiceSample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            // Create a queue
            System.out.println("Creating a new SQS queue called JimmyZ-Q.\n");
            CreateQueueRequest createQueueRequest = new CreateQueueRequest("JimmyZ-Q");
